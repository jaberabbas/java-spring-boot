...
public class EmployeeControllerTest {
    ...
    public void testCreate() throws JsonProcessingException, Exception {
        Department department = new Department(1L, "dept", "dept mock MVC test", "London", null);
    ...
    public void testGet() throws Exception {
        Department department = new Department(1L, "dept", "dept mock MVC test", "London", null);
        Employee employee = new Employee(1L, "Jon", "Smith", Double.valueOf("3000"), 40, "Developer", department);
    ...
    public void testGetAll() throws Exception {
        Department department1 = new Department(1L, "dept1", "dept mock MVC test", "London", null);
        Department department2 = new Department(2L, "dept2", "dept mock MVC test", "Paris", null);
